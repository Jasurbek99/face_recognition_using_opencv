...
def realtime_face_recognition():
    ...
    vid = cv2.VideoCapture("http://192.168.77.35:8080/video")
    ...
    while True:
        ...
        people = DeepFace.find(img_path=frame, db_path="dataset/", model_name=models[2], distance_metric=metrics[0], enforce_detection=False)
        # analysis = DeepFace.analyze(img_path = frame, actions = ["age", "gender", "emotion", "race"])
        # print(analysis)
        for person in people:
            ...
            try:
                ...
                # cv2.putText(frame,analysis["age"],x,y+20, cv2.FONT_ITALIC, 1, (0, 0, 255), 2)
            except:
                    print("error")
